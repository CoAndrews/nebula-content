...
const myFavoriteFoods = [["Short Ribs", "Arepas", "Tostones", "Duck Confit"], [1,2,3] ["boil", "fry", "sautee"]]
// Make a list of classmates names first names in an array
const myClassmates = ["Odalis","Chanel", "Juan", "Armani", "Aliesha"]
...
Array.isArray(myClassmates)
console.log(myClassmates[index-1])
