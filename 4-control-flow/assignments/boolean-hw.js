...
if (2 == "two"){
  console.log("yes, those are equal")
} else {
  console.log("they are not equal")
}
// // //2. Write a statement that checks if '2' and 2 are loosely equal
if (2 == 2){
  console.log("ah, yes...loose indeed.")
}else {
  console.log("they are not loosely equal...child, they are the same!")
}

// // //3. Write a statement that checks if 14 and '14' are strictly equal
if (14 === "14"){
  console.log("they are the same! perfect!")
}else {
  console.log("they are not strictly similar")
}
// // //4. Write a statement that checks if 10 is greater than -100
let cisco = 10
let farm = -100

let answerFinal = cisco > farm ? "BY GEORGE HE'S GOT IT!" : "OH NO...NO!"
...
if (4 === Math.round(4.4)){
  console.log("4 equals 4.4 rounded!")
}else {
  console.log("4 doesnt strickly equal 4.4 rounded")
}


// // //6. Write a statement that checks if 10 is greater than or equal to 9.1 rounded up
if (10 > Math.ceil(9.1)){
  console.log("ROUND ROUND ROUND WE GO! 10 is bigger!")
}else if (10 === Math.ceil(9.1)) {
